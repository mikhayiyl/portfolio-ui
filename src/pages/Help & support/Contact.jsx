import { Email, Facebook, GitHub, LocationOn, PhoneAndroid, SendOutlined, Twitter } from "@material-ui/icons";
            ...
            <main id="contact" className={theme}>
                <div className="textarea">
                    ...
                    <div className="contact-item">
                        <textarea type="text" className="form-control" placeholder="send message" />
